...
import 'xml_document_unidentified_sql_database_entity_mapper.dart';
...
abstract class EntityListMapper<
    ...
    Mapper extends EntityMapper<SDBaseEntity, SDCoreEntity, SDRelationalIds,
        SDRelationalEntity, XDEntity>> {
  final Mapper mapper;
